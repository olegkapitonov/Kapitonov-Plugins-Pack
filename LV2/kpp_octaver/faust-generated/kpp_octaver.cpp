...
#ifndef  __kpp_octaver_H__
#define  __kpp_octaver_H__
...
float kpp_octaver_faustpower2_f(float value) {
	return (value * value);
	
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS kpp_octaver
#endif
#ifdef __APPLE__ 
...
class kpp_octaver : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "kpp_octaver");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst1 = tanf((753.982239f / fConst0));
		fConst2 = (1.0f / fConst1);
		fConst3 = (1.0f / (((fConst2 + 1.0f) / fConst1) + 1.0f));
		fConst4 = (fConst2 + 1.0f);
		fConst5 = (0.0f - ((1.0f - fConst2) / fConst4));
		fConst6 = (1.0f / fConst4);
		fConst7 = tanf((219.911484f / fConst0));
		fConst8 = (1.0f / fConst7);
		fConst9 = (1.0f / (((fConst8 + 1.41421354f) / fConst7) + 1.0f));
		fConst10 = (1.0f / kpp_octaver_faustpower2_f(fConst7));
		fConst11 = tanf((251.327408f / fConst0));
		fConst12 = (1.0f / fConst11);
		fConst13 = (1.0f / (((fConst12 + 1.0f) / fConst11) + 1.0f));
		fConst14 = (fConst12 + 1.0f);
		fConst15 = (0.0f - ((1.0f - fConst12) / fConst14));
		fConst16 = tanf((1005.30963f / fConst0));
		fConst17 = (1.0f / fConst16);
		fConst18 = (((fConst17 + 0.618034005f) / fConst16) + 1.0f);
		fConst19 = (1.0f / (fConst18 * fConst14));
		fConst20 = (1.0f / (((fConst17 + 1.61803401f) / fConst16) + 1.0f));
		fConst21 = (fConst17 + 1.0f);
		fConst22 = (0.0f - ((1.0f - fConst17) / fConst21));
		fConst23 = (1.0f / fConst21);
		fConst24 = (((fConst17 + -1.61803401f) / fConst16) + 1.0f);
		fConst25 = (2.0f * (1.0f - (1.0f / kpp_octaver_faustpower2_f(fConst16))));
		fConst26 = (1.0f / fConst18);
		fConst27 = (((fConst17 + -0.618034005f) / fConst16) + 1.0f);
		fConst28 = (((fConst12 + -1.0f) / fConst11) + 1.0f);
		fConst29 = (2.0f * (1.0f - (1.0f / kpp_octaver_faustpower2_f(fConst11))));
		fConst30 = (((fConst8 + -1.41421354f) / fConst7) + 1.0f);
		fConst31 = (2.0f * (1.0f - fConst10));
		fConst32 = (2.0f * (0.0f - fConst10));
		fConst33 = (((fConst2 + -1.0f) / fConst1) + 1.0f);
		fConst34 = (2.0f * (1.0f - (1.0f / kpp_octaver_faustpower2_f(fConst1))));
		fConst35 = tanf((376.991119f / fConst0));
		fConst36 = (1.0f / fConst35);
		fConst37 = (1.0f / (((fConst36 + 1.0f) / fConst35) + 1.0f));
		fConst38 = (fConst36 + 1.0f);
		fConst39 = (0.0f - ((1.0f - fConst36) / fConst38));
		fConst40 = (1.0f / fConst38);
		fConst41 = (((fConst36 + -1.0f) / fConst35) + 1.0f);
		fConst42 = (2.0f * (1.0f - (1.0f / kpp_octaver_faustpower2_f(fConst35))));
	...
	virtual kpp_octaver* clone() {
		return new kpp_octaver();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp2 = (fRec8[2] + (fRec8[0] + (2.0f * fRec8[1])));
			fVec1[0] = fTemp2;
			fRec7[0] = ((fConst15 * fRec7[1]) + (fConst19 * (fTemp2 + fVec1[1])));
			fRec6[0] = (fRec7[0] - (fConst13 * ((fConst28 * fRec6[2]) + (fConst29 * fRec6[1]))));
			fRec5[0] = ((fConst13 * (fRec6[2] + (fRec6[0] + (2.0f * fRec6[1])))) - (fConst9 * ((fConst30 * fRec5[2]) + (fConst31 * fRec5[1]))));
			float fTemp3 = (fRec4[1] + (fConst9 * (((fConst10 * fRec5[0]) + (fConst32 * fRec5[1])) + (fConst10 * fRec5[2]))));
			fRec4[0] = min(-9.99999975e-06f, max(-9.99999975e-06f, float(((fTemp3 > 0.0f) - (fTemp3 < 0.0f)))));
			float fTemp4 = max(0.0f, (fRec4[0] - fRec4[1]));
			fRec3[0] = min(1.0f, max(-1.0f, (10000.0f * ((fRec3[1] * (1.0f - (2.0f * float(((fTemp4 > 0.0f) - (fTemp4 < 0.0f)))))) + 0.100000001f))));
			float fTemp5 = min(1.0f, max(0.0f, fRec3[0]));
			float fTemp6 = (fTemp5 * fTemp1);
			fVec2[0] = fTemp6;
			fRec2[0] = ((fConst5 * fRec2[1]) + (fConst6 * (fTemp6 + fVec2[1])));
			fRec1[0] = (fRec2[0] - (fConst3 * ((fConst33 * fRec1[2]) + (fConst34 * fRec1[1]))));
			fRec22[0] = ((fTemp6 + (0.995000005f * fRec22[1])) - fVec2[1]);
			fRec21[0] = ((fConst22 * fRec21[1]) + (fConst23 * (fRec22[0] + fRec22[1])));
			fRec20[0] = (fRec21[0] - (fConst20 * ((fConst24 * fRec20[2]) + (fConst25 * fRec20[1]))));
			fRec19[0] = ((fConst20 * (fRec20[2] + (fRec20[0] + (2.0f * fRec20[1])))) - (fConst26 * ((fConst27 * fRec19[2]) + (fConst25 * fRec19[1]))));
			float fTemp7 = (fRec19[2] + (fRec19[0] + (2.0f * fRec19[1])));
			fVec3[0] = fTemp7;
			fRec18[0] = ((fConst15 * fRec18[1]) + (fConst19 * (fTemp7 + fVec3[1])));
			fRec17[0] = (fRec18[0] - (fConst13 * ((fConst28 * fRec17[2]) + (fConst29 * fRec17[1]))));
			fRec16[0] = ((fConst13 * (fRec17[2] + (fRec17[0] + (2.0f * fRec17[1])))) - (fConst9 * ((fConst30 * fRec16[2]) + (fConst31 * fRec16[1]))));
			float fTemp8 = (fRec15[1] + (fConst9 * (((fConst10 * fRec16[0]) + (fConst32 * fRec16[1])) + (fConst10 * fRec16[2]))));
			fRec15[0] = min(-9.99999975e-06f, max(-9.99999975e-06f, float(((fTemp8 > 0.0f) - (fTemp8 < 0.0f)))));
			float fTemp9 = max(0.0f, (fRec15[0] - fRec15[1]));
			fRec14[0] = min(1.0f, max(-1.0f, (10000.0f * ((fRec14[1] * (1.0f - (2.0f * float(((fTemp9 > 0.0f) - (fTemp9 < 0.0f)))))) + 0.100000001f))));
			float fTemp10 = ((fTemp5 * min(1.0f, max(0.0f, fRec14[0]))) * fTemp1);
			fVec4[0] = fTemp10;
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/kpp_octaver"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      kpp_octaver* tmp_dsp = new kpp_octaver();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "kpp_octaver");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (kpp_octaver**)calloc(ndsps, sizeof(kpp_octaver*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "kpp_octaver";
