...
#ifndef  __kpp_fuzz_H__
#define  __kpp_fuzz_H__
...
float kpp_fuzz_faustpower2_f(float value) {
	return (value * value);
	
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS kpp_fuzz
#endif
#ifdef __APPLE__ 
...
class kpp_fuzz : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst1 = tanf((2261.94678f / fConst0));
		fConst2 = (1.0f / fConst1);
		fConst3 = (((fConst2 + 1.0f) / fConst1) + 1.0f);
		fConst4 = (0.000500000024f / fConst3);
		...
		fConst12 = (1.0f / tanf((5403.53955f / fConst0)));
		fConst13 = (fConst12 + 1.0f);
		fConst14 = (0.0f - ((1.0f - fConst12) / fConst13));
		fConst15 = (1.0f / fConst13);
		fConst16 = (0.0f - fConst8);
		fConst17 = (1.0f / fConst3);
		fConst18 = (((fConst2 + -1.0f) / fConst1) + 1.0f);
		fConst19 = (1.0f / kpp_fuzz_faustpower2_f(fConst1));
		fConst20 = (2.0f * (1.0f - fConst19));
		fConst21 = (0.0f - fConst2);
		fConst22 = (2.0f * (0.0f - fConst19));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (fConst4 * powf(10.0f, (2.5f * float(fVslider0))));
		float fSlow2 = float(fVslider1);
		float fSlow3 = powf(10.0f, (0.00999999978f * fSlow2));
		float fSlow4 = (10.0f * powf(10.0f, (0.00499999989f * fSlow2)));
		float fSlow5 = powf(10.0f, (0.0500000007f * (float(fVslider2) + 7.5f)));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = (float(input1[i]) + float(input0[i]));
			float fTemp1 = (iSlow0?0.0f:fTemp0);
			fVec0[0] = fTemp1;
			fRec4[0] = (((0.995000005f * fRec4[1]) + fTemp1) - fVec0[1]);
			fRec3[0] = ((fConst14 * fRec3[1]) + (fConst15 * (fRec4[0] + fRec4[1])));
			float fTemp2 = min(1.0f, max(0.0f, ((fSlow4 * fRec3[0]) + 0.5f)));
			fVec1[0] = fTemp2;
			fRec2[0] = ((fConst10 * fRec2[1]) + (fConst11 * ((fConst8 * fTemp2) + (fConst16 * fVec1[1]))));
			float fTemp3 = (min(1.0f, max(-1.0f, (fSlow3 * (kpp_fuzz_faustpower2_f((fRec2[0] + 0.5f)) + -0.400000006f)))) + 0.150000006f);
			fVec2[0] = fTemp3;
			fRec1[0] = ((fConst6 * fRec1[1]) + (fConst7 * (fTemp3 + fVec2[1])));
			fRec0[0] = (fRec1[0] - (fConst17 * ((fConst18 * fRec0[2]) + (fConst20 * fRec0[1]))));
			fRec6[0] = ((fConst6 * fRec6[1]) + (fConst7 * ((fConst2 * fTemp3) + (fConst21 * fVec2[1]))));
			fRec5[0] = (fRec6[0] - (fConst17 * ((fConst18 * fRec5[2]) + (fConst20 * fRec5[1]))));
			float fTemp4 = (iSlow0?fTemp0:(fSlow1 * ((fRec0[2] + (fRec0[0] + (2.0f * fRec0[1]))) + (fSlow5 * (((fConst19 * fRec5[0]) + (fConst22 * fRec5[1])) + (fConst19 * fRec5[2]))))));
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/kpp_fuzz"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (kpp_fuzz**)calloc(ndsps, sizeof(kpp_fuzz*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "kpp_fuzz";
