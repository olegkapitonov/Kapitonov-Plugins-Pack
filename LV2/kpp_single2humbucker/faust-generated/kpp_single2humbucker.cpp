...
#ifndef  __kpp_single2humbucker_H__
#define  __kpp_single2humbucker_H__
...
float kpp_single2humbucker_faustpower2_f(float value) {
	return (value * value);
	
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS kpp_single2humbucker
#endif
#ifdef __APPLE__ 
...
class kpp_single2humbucker : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "kpp_single2humbucker");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst3 = (fConst2 / sinf((3455.75195f * fConst2)));
		fConst4 = (2356.19458f * fConst3);
		fConst5 = tanf((1727.87598f / fConst0));
		fConst6 = (1.0f / fConst5);
		fConst7 = (1.0f / (((fConst4 + fConst6) / fConst5) + 1.0f));
		fConst8 = (2.0f * (1.0f - (1.0f / kpp_single2humbucker_faustpower2_f(fConst5))));
		fConst9 = tanf((17278.7598f / fConst0));
		fConst10 = (1.0f / fConst9);
		fConst11 = (1.0f / (((fConst10 + 1.41421354f) / fConst9) + 1.0f));
		fConst12 = (1.0f / tanf((62.831852f / fConst0)));
		fConst13 = (fConst12 + 1.0f);
		fConst14 = (0.0f - ((1.0f - fConst12) / fConst13));
		fConst15 = (1.0f / fConst13);
		fConst16 = (0.0f - fConst12);
		iConst17 = int(min(50.0f, max(0.0f, (0.000173611115f * fConst0))));
		fConst18 = (((fConst10 + -1.41421354f) / fConst9) + 1.0f);
		fConst19 = (2.0f * (1.0f - (1.0f / kpp_single2humbucker_faustpower2_f(fConst9))));
		fConst20 = (((fConst6 - fConst4) / fConst5) + 1.0f);
		fConst21 = (4701.22607f * fConst3);
		fConst22 = (((fConst21 + fConst6) / fConst5) + 1.0f);
		fConst23 = (((fConst6 - fConst21) / fConst5) + 1.0f);
	...
	virtual kpp_single2humbucker* clone() {
		return new kpp_single2humbucker();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = (1.0f / tanf((fConst1 * float(fVslider0))));
		float fSlow1 = (fSlow0 + 1.0f);
		float fSlow2 = (0.0f - ((1.0f - fSlow0) / fSlow1));
		float fSlow3 = (1.0f / fSlow1);
		float fSlow4 = float(fVslider1);
		float fSlow5 = (fConst12 * fSlow4);
		float fSlow6 = (1.0f - fSlow4);
		float fSlow7 = (0.0f - fSlow0);
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = (float(input0[i]) + float(input1[i]));
			fVec0[0] = (fSlow4 * fTemp0);
			fRec3[(IOTA & 63)] = ((fConst14 * fRec3[((IOTA - 1) & 63)]) + (fConst15 * ((fSlow5 * fTemp0) + (fConst16 * fVec0[1]))));
			fRec2[0] = ((fRec3[((IOTA - 0) & 63)] + fRec3[((IOTA - iConst17) & 63)]) - (fConst11 * ((fConst18 * fRec2[2]) + (fConst19 * fRec2[1]))));
			float fTemp1 = (fConst8 * fRec1[1]);
			fRec1[0] = ((fConst11 * (fRec2[2] + (fRec2[0] + (2.0f * fRec2[1])))) - (fConst7 * ((fConst20 * fRec1[2]) + fTemp1)));
			float fTemp2 = ((fConst7 * ((fTemp1 + (fConst22 * fRec1[0])) + (fConst23 * fRec1[2]))) + (fSlow6 * fTemp0));
			fVec1[0] = fTemp2;
			fRec0[0] = ((fSlow2 * fRec0[1]) + (fSlow3 * ((fSlow0 * fTemp2) + (fSlow7 * fVec1[1]))));
			float fTemp3 = (0.316227764f * fRec0[0]);
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/kpp_single2humbucker"
#endif
...
struct LV2Plugin {
  ...
  kpp_single2humbucker **dsp;		// the dsps
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      kpp_single2humbucker* tmp_dsp = new kpp_single2humbucker();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "kpp_single2humbucker");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (kpp_single2humbucker**)calloc(ndsps, sizeof(kpp_single2humbucker*));
    ...
    for (int i = 0; i < ndsps; i++) {
      dsp[i] = new kpp_single2humbucker();
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "kpp_single2humbucker";
...
<%s>\n\
       a lv2:Plugin%s ;\n\
       doap:name \"%s\" ;\n\
       lv2:binary <kpp_single2humbucker%s> ;\n\
